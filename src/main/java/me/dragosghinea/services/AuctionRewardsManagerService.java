...
public interface AuctionRewardsManagerService {

    boolean setReward(Reward reward);
     ...
     * @return true if the reward was removed successfully,
     * false otherwise
     */
     ...
     * @param description The description of the new bundle
     * @return true if the bundle was created
